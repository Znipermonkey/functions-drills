...
function faveColorFinder(color){
  if(color === "red"){
    ...
    return `you need to evaluat your favorite color choice`
  }
}
...
let bigOrSmall = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++){
    ...
    if(arr[i] >= 100){
      arrEvaluator.push('big')
    }else{
      arrEvaluator.push('small')
    }
  }
  return arrEvaluator
}
